...
CREATE TABLE state_log (
    state_log_id         BIGINT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE production_log (
    production_log_id   BIGINT GENERATED BY DEFAULT AS IDENTITY,
    asset_id            BIGINT NOT NULL REFERENCES asset_definition(asset_id),
    asset_name          TEXT NOT NULL,
...
CREATE TABLE count_log (
    count_log_id        BIGINT GENERATED BY DEFAULT AS IDENTITY,
    asset_id            BIGINT NOT NULL REFERENCES asset_definition(asset_id),
    asset_name          TEXT NOT NULL,
...
CREATE TABLE measurement_log (
    measurement_log_id        BIGINT GENERATED BY DEFAULT AS IDENTITY,
    asset_id              BIGINT NOT NULL REFERENCES asset_definition(asset_id),
    asset_name            TEXT NOT NULL,
...
CREATE TABLE kpi_log (
    kpi_log_id     BIGINT GENERATED BY DEFAULT AS IDENTITY,
    asset_id       BIGINT NOT NULL REFERENCES asset_definition(asset_id),
    asset_name     TEXT NOT NULL,
