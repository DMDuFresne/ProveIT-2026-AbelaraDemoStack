# Cloudflare Tunnel Configuration - SCADA
...
3. Add the token to your `.env` file as `SCADA_CLOUDFLARE_TUNNEL_TOKEN`

## Public Hostname Configuration

Configure the following public hostname in the Cloudflare dashboard:

| Subdomain | Domain | Service |
|-----------|--------|---------|
| ignition.scada | yourdomain.com | http://nginx:80 |
